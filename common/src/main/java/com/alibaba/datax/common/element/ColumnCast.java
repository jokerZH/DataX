...
class StringCast {
	...
	static void init(final Configuration configuration) {
		...
		StringCast.extraFormats = configuration.getList("common.column.extraFormats", Collections.<String>emptyList(), String.class);
	...
	static Date asDate(final StringColumn column) throws ParseException {
		...
		} catch (ParseException ignored) { e = ignored; }
